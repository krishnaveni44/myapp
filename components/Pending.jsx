...
export default function Pending() {
  ...
  <ScrollView>
      ...
      <Image 
        source={require('../assets/images/warning-icon.webp')} 
      ...
      <View style={styles.resultTxtContainer}>  
        <Text style={styles.resultText1}>Transaction Pending</Text>

      <Text style={styles.resultText2}>Transaction with the payment</Text>
      <Text style={styles.resultText2}>reference 538901388 is still pending</Text>
      </View>
